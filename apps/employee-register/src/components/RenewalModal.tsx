            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-lg font-bold tabular-nums font-(--font-display)">
                  ${eligibility.extension2hTotal != null ? eligibility.extension2hTotal.toFixed(2) : '20.00'}
                </span>
              </div>
          ...
          {eligibility.canExtend6h && (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-lg font-bold tabular-nums font-(--font-display)">
                  ${eligibility.extension6hTotal != null ? eligibility.extension6hTotal.toFixed(2) : '0.00'}
                </span>
              </div>
