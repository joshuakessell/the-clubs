    ...
    <div className="flex flex-col shrink-0">
      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div
            className="flex h-7 w-7 items-center justify-center overflow-hidden shrink-0"
          >
            <img src="/club-dallas-logo.svg" alt="Club Dallas" width="28" height="28" />
          </div>
        ...
        <div ref={searchRef} className="relative flex-1 max-w-md">
          <div className="flex items-center gap-2 rounded-lg border px-3" style={{
...
function SearchIcon() {
  return (
    <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--color-text-muted)' }} aria-hidden="true">
