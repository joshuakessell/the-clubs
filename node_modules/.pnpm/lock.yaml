...
importers:
  ...
  apps/customer-kiosk:
    ...
    devDependencies:
      ...
      '@vitejs/plugin-react':
        specifier: ^5.1.1
        version: 5.1.4(vite@8.0.0-beta.15(@types/node@24.10.13)(jiti@2.6.1))
      autoprefixer:
        specifier: ^10.4.24
      ...
      vite:
        ...
        version: 8.0.0-beta.15(@types/node@24.10.13)(jiti@2.6.1)
...
packages:
  ...
  preline@4.0.1:
    resolution: {integrity: sha512-/cyb8orusmZSymGDkCCmDvbfccK5n3fnRZ3uG59pKihxpagmJ6p1rwkXpX1uZ7VpEQrug7U8IYBJnFGaD+8Bdw==}
    hasBin: true
...
snapshots:
  ...
  '@vitejs/plugin-react@5.1.4(vite@8.0.0-beta.15(@types/node@24.10.13))':
    dependencies:
      '@babel/core': 7.29.0
      '@babel/plugin-transform-react-jsx-self': 7.27.1(@babel/core@7.29.0)
      '@babel/plugin-transform-react-jsx-source': 7.27.1(@babel/core@7.29.0)
      ...
      '@types/babel__core': 7.20.5
      react-refresh: 0.18.0
      vite: 8.0.0-beta.15(@types/node@24.10.13)
    transitivePeerDependencies:
      - supports-color
