import { z } from 'zod';
export declare const ClubEventDomainSchema: z.ZodEnum<["HR", "SALES", "CHECKIN", "CHECKOUT", "INVENTORY", "ADMIN"]>;
export type ClubEventDomain = z.infer<typeof ClubEventDomainSchema>;
export declare const ClubEventTypeSchema: z.ZodEnum<["EMPLOYEE_CLOCK_IN", "EMPLOYEE_CLOCK_OUT", "REGISTER_SIGN_IN", "REGISTER_SIGN_OUT", "BREAK_START", "BREAK_END", "SALE_COMPLETED", "ADDON_SOLD", "UPGRADE_PAID", "LATE_FEE_CHARGED", "REFUND_ISSUED", "CHECKIN_STARTED", "CHECKIN_COMPLETED", "MEMBERSHIP_SELECTED", "CHECKOUT_REQUESTED", "CHECKOUT_COMPLETED", "ROOM_STATUS_CHANGED", "ROOM_ASSIGNED", "LOCKER_ASSIGNED", "NOTE_ADDED", "PAST_DUE_WAIVED", "OVERRIDE_APPLIED"]>;
