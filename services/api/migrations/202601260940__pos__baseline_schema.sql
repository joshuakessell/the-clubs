-- Establish baseline schema for POS domain tables.
-- These tables were previously created in 005_add_pos_domain_tables.sql.
-- up migration
...
-- down migration
DROP TABLE IF EXISTS public.external_provider_refs CASCADE;
DROP TABLE IF EXISTS public.receipts CASCADE;
DROP TABLE IF EXISTS public.order_line_items CASCADE;
DROP TABLE IF EXISTS public.orders CASCADE;
DROP TABLE IF EXISTS public.staff_break_sessions CASCADE;
DROP TABLE IF EXISTS public.cash_drawer_events CASCADE;
DROP TABLE IF EXISTS public.cash_drawer_sessions CASCADE;
