...
exports.roomStatus = (0, pg_core_1.pgEnum)("room_status", ['DIRTY', 'CLEANING', 'CLEAN', 'OCCUPIED']);
...
exports.paymentIntents = (0, pg_core_1.pgTable)("payment_intents", {
    ...
    laneSessionId: (0, pg_core_1.uuid)("lane_session_id"),
    amount: (0, pg_core_1.numeric)({ precision: 10, scale: 2 }).notNull(),
    tipCents: (0, pg_core_1.integer)("tip_cents").default(0).notNull(),
...
exports.cashDrawerSessions = (0, pg_core_1.pgTable)("cash_drawer_sessions", {
    ...
    openingFloatCents: (0, pg_core_1.integer)("opening_float_cents").notNull(),
    ...
    countedCashCents: (0, pg_core_1.integer)("counted_cash_cents"),
    expectedCashCents: (0, pg_core_1.integer)("expected_cash_cents"),
    overShortCents: (0, pg_core_1.integer)("over_short_cents"),
    notes: (0, pg_core_1.text)(),
...
exports.cashDrawerEvents = (0, pg_core_1.pgTable)("cash_drawer_events", {
    ...
    amountCents: (0, pg_core_1.integer)("amount_cents"),
    reason: (0, pg_core_1.text)(),
...
exports.orders = (0, pg_core_1.pgTable)("orders", {
    ...
    discountCents: (0, pg_core_1.integer)("discount_cents").notNull(),
    taxCents: (0, pg_core_1.integer)("tax_cents").notNull(),
    tipCents: (0, pg_core_1.integer)("tip_cents").default(0).notNull(),
...
exports.orderLineItems = (0, pg_core_1.pgTable)("order_line_items", {
    ...
    discountCents: (0, pg_core_1.integer)("discount_cents").default(0).notNull(),
    taxCents: (0, pg_core_1.integer)("tax_cents").default(0).notNull(),
    totalCents: (0, pg_core_1.integer)("total_cents").notNull(),
    metadataJson: (0, pg_core_1.jsonb)("metadata_json"),
}, (table) => [
...
exports.lateCheckoutBanAlerts = (0, pg_core_1.pgTable)("late_checkout_ban_alerts", {
    ...
    visitId: (0, pg_core_1.uuid)("visit_id"),
    lateMinutes: (0, pg_core_1.integer)("late_minutes").notNull(),
    feeAmountCents: (0, pg_core_1.integer)("fee_amount_cents").notNull(),
...
exports.clubEvents = (0, pg_core_1.pgTable)("club_events", {
    ...
    (0, pg_core_1.index)("idx_club_events_amount").using("btree", table.amountCents.asc().nullsLast().op("int4_ops"), table.occurredAt.desc().nullsFirst().op("int4_ops")).where((0, drizzle_orm_1.sql) `(amount_cents IS NOT NULL)`),
...
exports.products = (0, pg_core_1.pgTable)("products", {
    ...
    sku: (0, pg_core_1.text)(),
    name: (0, pg_core_1.text)().notNull(),
    priceCents: (0, pg_core_1.integer)("price_cents").default(0).notNull(),
