...
exports.staffBreakSessions = exports.cashDrawerEvents = exports.cashDrawerSessions = exports.auditLog = exports.lateCheckoutEvents = exports.cleaningEvents = exports.cleaningBatchRooms = exports.cleaningBatches = exports.checkoutRequests = exports.registerSessions = exports.devices = exports.inventoryReservations = exports.checkinBlocks = exports.agreementSignatures = exports.agreements = exports.waitlist = exports.keyTags = exports.inventoryResources = exports.webauthnChallenges = exports.timeclockSessions = exports.timeOffRequests = exports.staffWebauthnCredentials = exports.employeeShifts = exports.staffSessions = exports.employeeDocuments = exports.staff = exports.schemaMigrations = exports.customers = exports.visits = exports.waitlistStatus = exports.timeOffRequestStatus = exports.staffRole = exports.shiftStatus = exports.roomType = exports.roomStatus = exports.rentalType = exports.orderStatus = exports.orderLineItemKind = exports.laneSessionStatus = exports.keyTagType = exports.inventoryResourceType = exports.inventoryReservationKind = exports.externalProviderEntityType = exports.checkoutRequestStatus = exports.cashDrawerSessionStatus = exports.cashDrawerEventType = exports.breakType = exports.breakStatus = exports.blockType = exports.auditAction = void 0;
...
exports.orderLineItemKind = (0, pg_core_1.pgEnum)("order_line_item_kind", ['RETAIL', 'ADDON', 'UPGRADE', 'LATE_FEE', 'MANUAL', 'CHECKIN_FEE', 'RENEWAL_FEE', 'FINAL_EXTENSION']);
...
exports.visits = (0, pg_core_1.pgTable)("visits", {
    ...
    startedAt: (0, pg_core_1.timestamp)("started_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    endedAt: (0, pg_core_1.timestamp)("ended_at", { withTimezone: true, mode: 'date' }),
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)("updated_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
...
exports.customers = (0, pg_core_1.pgTable)("customers", {
    ...
    bannedUntil: (0, pg_core_1.timestamp)("banned_until", { withTimezone: true, mode: 'date' }),
...
exports.schemaMigrations = (0, pg_core_1.pgTable)("schema_migrations", {
    ...
    name: (0, pg_core_1.varchar)({ length: 255 }).notNull(),
    executedAt: (0, pg_core_1.timestamp)("executed_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
...
exports.employeeDocuments = (0, pg_core_1.pgTable)("employee_documents", {
    ...
    uploadedAt: (0, pg_core_1.timestamp)("uploaded_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
...
exports.staffSessions = (0, pg_core_1.pgTable)("staff_sessions", {
    ...
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    revokedAt: (0, pg_core_1.timestamp)("revoked_at", { withTimezone: true, mode: 'date' }),
    expiresAt: (0, pg_core_1.timestamp)("expires_at", { withTimezone: true, mode: 'date' }).notNull(),
    reauthOkUntil: (0, pg_core_1.timestamp)("reauth_ok_until", { withTimezone: true, mode: 'date' }),
}, (table) => [
...
exports.employeeShifts = (0, pg_core_1.pgTable)("employee_shifts", {
    id: (0, pg_core_1.uuid)().defaultRandom().primaryKey().notNull(),
    employeeId: (0, pg_core_1.uuid)("employee_id").notNull(),
    startsAt: (0, pg_core_1.timestamp)("starts_at", { withTimezone: true, mode: 'date' }).notNull(),
    endsAt: (0, pg_core_1.timestamp)("ends_at", { withTimezone: true, mode: 'date' }).notNull(),
...
exports.staffWebauthnCredentials = (0, pg_core_1.pgTable)("staff_webauthn_credentials", {
    ...
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    lastUsedAt: (0, pg_core_1.timestamp)("last_used_at", { withTimezone: true, mode: 'date' }),
    revokedAt: (0, pg_core_1.timestamp)("revoked_at", { withTimezone: true, mode: 'date' }),
}, (table) => [
...
exports.timeOffRequests = (0, pg_core_1.pgTable)("time_off_requests", {
    ...
    decidedAt: (0, pg_core_1.timestamp)("decided_at", { withTimezone: true, mode: 'date' }),
...
exports.timeclockSessions = (0, pg_core_1.pgTable)("timeclock_sessions", {
    ...
    clockInAt: (0, pg_core_1.timestamp)("clock_in_at", { withTimezone: true, mode: 'date' }).notNull(),
    clockOutAt: (0, pg_core_1.timestamp)("clock_out_at", { withTimezone: true, mode: 'date' }),
...
exports.inventoryResources = (0, pg_core_1.pgTable)("inventory_resources", {
    id: (0, pg_core_1.uuid)().defaultRandom().primaryKey().notNull(),
    kind: (0, exports.inventoryResourceType)().notNull(),
    number: (0, pg_core_1.varchar)({ length: 20 }).notNull(),
    tier: (0, exports.roomType)().default('STANDARD').notNull(),
    status: (0, exports.roomStatus)().default('CLEAN').notNull(),
    floor: (0, pg_core_1.integer)(),
    lastStatusChange: (0, pg_core_1.timestamp)("last_status_change", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    ...
    (0, pg_core_1.index)("idx_ir_kind").using("btree", table.kind.asc().nullsLast().op("enum_ops")),
    (0, pg_core_1.index)("idx_ir_status").using("btree", table.status.asc().nullsLast().op("enum_ops")),
    (0, pg_core_1.index)("idx_ir_tier").using("btree", table.tier.asc().nullsLast().op("enum_ops")),
    (0, pg_core_1.index)("idx_ir_assigned").using("btree", table.assignedToCustomerId.asc().nullsLast().op("uuid_ops")).where((0, drizzle_orm_1.sql) `(assigned_to_customer_id IS NOT NULL)`),
    (0, pg_core_1.index)("idx_ir_floor").using("btree", table.floor.asc().nullsLast().op("int4_ops")).where((0, drizzle_orm_1.sql) `(floor IS NOT NULL)`),
    (0, pg_core_1.foreignKey)({
        columns: [table.assignedToCustomerId],
        foreignColumns: [exports.customers.id],
        name: "inventory_resources_assigned_to_customer_id_fkey"
    }).onDelete("set null"),
    (0, pg_core_1.unique)("inventory_resources_number_key").on(table.number),
]);
exports.keyTags = (0, pg_core_1.pgTable)("key_tags", {
    ...
    (0, pg_core_1.index)("idx_key_tags_resource").using("btree", table.resourceId.asc().nullsLast().op("uuid_ops")),
    (0, pg_core_1.foreignKey)({
        columns: [table.resourceId],
        foreignColumns: [exports.inventoryResources.id],
        name: "key_tags_resource_id_fkey"
    }).onDelete("cascade"),
    (0, pg_core_1.unique)("key_tags_tag_code_key").on(table.tagCode),
    (0, pg_core_1.check)("key_tags_resource_id_nn", (0, drizzle_orm_1.sql) `resource_id IS NOT NULL`),
]);
exports.waitlist = (0, pg_core_1.pgTable)("waitlist", {
    ...
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)("updated_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    offeredAt: (0, pg_core_1.timestamp)("offered_at", { withTimezone: true, mode: 'date' }),
    offerExpiresAt: (0, pg_core_1.timestamp)("offer_expires_at", { withTimezone: true, mode: 'date' }),
    lastOfferedAt: (0, pg_core_1.timestamp)("last_offered_at", { withTimezone: true, mode: 'date' }),
    ...
    cancelledAt: (0, pg_core_1.timestamp)("cancelled_at", { withTimezone: true, mode: 'date' }),
    ...
    (0, pg_core_1.index)("idx_waitlist_resource").using("btree", table.resourceId.asc().nullsLast().op("uuid_ops")).where((0, drizzle_orm_1.sql) `(resource_id IS NOT NULL)`),
...
exports.agreementSignatures = (0, pg_core_1.pgTable)("agreement_signatures", {
    ...
    membershipNumber: (0, pg_core_1.varchar)("membership_number", { length: 50 }),
    signedAt: (0, pg_core_1.timestamp)("signed_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
...
exports.checkinBlocks = (0, pg_core_1.pgTable)("checkin_blocks", {
    ...
    agreementSignedAt: (0, pg_core_1.timestamp)("agreement_signed_at", { withTimezone: true, mode: 'date' }),
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)("updated_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    ...
    (0, pg_core_1.index)("idx_checkin_blocks_resource").using("btree", table.resourceId.asc().nullsLast().op("uuid_ops")).where((0, drizzle_orm_1.sql) `(resource_id IS NOT NULL)`),
...
exports.inventoryReservations = (0, pg_core_1.pgTable)("inventory_reservations", {
    ...
    releasedAt: (0, pg_core_1.timestamp)("released_at", { withTimezone: true, mode: 'date' }),
...
exports.devices = (0, pg_core_1.pgTable)("devices", {
    ...
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    lastHeartbeat: (0, pg_core_1.timestamp)("last_heartbeat", { withTimezone: true, mode: 'date' }),
...
exports.registerSessions = (0, pg_core_1.pgTable)("register_sessions", {
    ...
    lastHeartbeat: (0, pg_core_1.timestamp)("last_heartbeat", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    signedOutAt: (0, pg_core_1.timestamp)("signed_out_at", { withTimezone: true, mode: 'date' }),
    closeoutSummaryJson: (0, pg_core_1.jsonb)("closeout_summary_json"),
    lastActivityAt: (0, pg_core_1.timestamp)("last_activity_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
}, (table) => [
...
exports.checkoutRequests = (0, pg_core_1.pgTable)("checkout_requests", {
    ...
    claimedAt: (0, pg_core_1.timestamp)("claimed_at", { withTimezone: true, mode: 'date' }),
    claimExpiresAt: (0, pg_core_1.timestamp)("claim_expires_at", { withTimezone: true, mode: 'date' }),
...
exports.cleaningBatchRooms = (0, pg_core_1.pgTable)("cleaning_batch_rooms", {
    ...
    transitionTime: (0, pg_core_1.timestamp)("transition_time", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    overrideFlag: (0, pg_core_1.boolean)("override_flag").default(false).notNull(),
    ...
    (0, pg_core_1.index)("idx_cleaning_batch_rooms_resource").using("btree", table.resourceId.asc().nullsLast().op("uuid_ops")),
    ...
    (0, pg_core_1.unique)("cleaning_batch_rooms_batch_id_resource_id_key").on(table.batchId, table.resourceId),
]);
exports.cleaningEvents = (0, pg_core_1.pgTable)("cleaning_events", {
    ...
    (0, pg_core_1.index)("idx_cleaning_events_resource").using("btree", table.resourceId.asc().nullsLast().op("uuid_ops")),
...
exports.cashDrawerSessions = (0, pg_core_1.pgTable)("cash_drawer_sessions", {
    ...
    openedAt: (0, pg_core_1.timestamp)("opened_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    openingFloat: (0, pg_core_1.integer)("opening_float").notNull(),
    closedByStaffId: (0, pg_core_1.uuid)("closed_by_staff_id"),
    closedAt: (0, pg_core_1.timestamp)("closed_at", { withTimezone: true, mode: 'date' }),
...
exports.cashDrawerEvents = (0, pg_core_1.pgTable)("cash_drawer_events", {
    ...
    occurredAt: (0, pg_core_1.timestamp)("occurred_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
...
exports.orders = (0, pg_core_1.pgTable)("orders", {
    ...
    tax: (0, pg_core_1.numeric)("tax", { precision: 10, scale: 2 }).notNull(),
    tip: (0, pg_core_1.numeric)("tip", { precision: 10, scale: 2 }).default('0').notNull(),
    ...
    quoteJson: (0, pg_core_1.jsonb)("quote_json").$type(),
    failureReason: (0, pg_core_1.text)("failure_reason"),
    failureAt: (0, pg_core_1.timestamp)("failure_at", { withTimezone: true, mode: 'date' }),
    ...
    (0, pg_core_1.index)("idx_orders_lane_session").using("btree", table.laneSessionId.asc().nullsLast().op("uuid_ops")).where((0, drizzle_orm_1.sql) `(lane_session_id IS NOT NULL)`),
    ...
    (0, pg_core_1.index)("idx_orders_visit").using("btree", table.visitId.asc().nullsLast().op("uuid_ops")).where((0, drizzle_orm_1.sql) `(visit_id IS NOT NULL)`),
    (0, pg_core_1.foreignKey)({
        columns: [table.customerId],
        foreignColumns: [exports.customers.id],
...
exports.orderLineItems = (0, pg_core_1.pgTable)("order_line_items", {
    ...
    discount: (0, pg_core_1.numeric)("discount", { precision: 10, scale: 2 }).default('0').notNull(),
    tax: (0, pg_core_1.numeric)("tax", { precision: 10, scale: 2 }).default('0').notNull(),
    total: (0, pg_core_1.numeric)("total", { precision: 10, scale: 2 }).notNull(),
    metadataJson: (0, pg_core_1.jsonb)("metadata_json"),
}, (table) => [
...
exports.receipts = (0, pg_core_1.pgTable)("receipts", {
    id: (0, pg_core_1.uuid)().defaultRandom().primaryKey().notNull(),
    orderId: (0, pg_core_1.uuid)("order_id").notNull(),
    issuedAt: (0, pg_core_1.timestamp)("issued_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
...
exports.offlineCommandOutbox = (0, pg_core_1.pgTable)("offline_command_outbox", {
    ...
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    replayedAt: (0, pg_core_1.timestamp)("replayed_at", { withTimezone: true, mode: 'date' }),
...
exports.customerNotes = (0, pg_core_1.pgTable)("customer_notes", {
    ...
    deletedAt: (0, pg_core_1.timestamp)("deleted_at", { withTimezone: true, mode: 'date' }),
}, (table) => [
...
exports.laneSessions = (0, pg_core_1.pgTable)("lane_sessions", {
    ...
    membershipPurchaseRequestedAt: (0, pg_core_1.timestamp)("membership_purchase_requested_at", { withTimezone: true, mode: 'date' }),
    membershipChoice: (0, pg_core_1.varchar)("membership_choice", { length: 20 }),
    kioskAcknowledgedAt: (0, pg_core_1.timestamp)("kiosk_acknowledged_at", { withTimezone: true, mode: 'date' }),
    createdAt: (0, pg_core_1.timestamp)("created_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)("updated_at", { withTimezone: true, mode: 'date' }).defaultNow().notNull(),
    ...
    selectionLockedAt: (0, pg_core_1.timestamp)("selection_locked_at", { withTimezone: true, mode: 'date' }),
    ...
    pastDueBypassedAt: (0, pg_core_1.timestamp)("past_due_bypassed_at", { withTimezone: true, mode: 'date' }),
    lastPaymentDeclineReason: (0, pg_core_1.text)("last_payment_decline_reason"),
    lastPaymentDeclineAt: (0, pg_core_1.timestamp)("last_payment_decline_at", { withTimezone: true, mode: 'date' }),
    lastPastDueDeclineReason: (0, pg_core_1.text)("last_past_due_decline_reason"),
    lastPastDueDeclineAt: (0, pg_core_1.timestamp)("last_past_due_decline_at", { withTimezone: true, mode: 'date' }),
}, (table) => [
